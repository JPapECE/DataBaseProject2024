...
CREATE INDEX idx_episode_combo_episode_combo_id ON Episode_Combo (episode_combo_id);
...
CREATE INDEX idx_national_cuisine_id ON National_Cuisine (national_cuisine_id);
...
#Indexes for Episode
CREATE INDEX idx_episode_id ON Episode (episode_id);
...
CREATE INDEX idx_episode_judge_episode_judge_id ON Episode_Judge (episode_judge_id);

#Indexes for Recipe
CREATE INDEX idx_recipe_id ON Recipe (recipe_id);
...
CREATE INDEX idx_thematic_unit_id ON Thematic_Unit (thematic_unit_id);
CREATE INDEX idx_thematic_unit_name ON Thematic_Unit (name);

#Indexes for Food_Group
CREATE INDEX idx_food_group_id ON Food_Group (food_group_id);
...
CREATE INDEX idx_ingredient_ingredient_id ON Ingredient (ingredient_id);
