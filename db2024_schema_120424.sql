...
CREATE TABLE Recipe_Ingredient (
    ...
    CONSTRAINT fk_recipe_thematic_unit_recipe FOREIGN KEY (recipe_id) REFERENCES Recipe (recipe_id) ON DELETE RESTRICT ON UPDATE CASCADE,
	CONSTRAINT fk_recipe_thematic_unit_thematic_unit FOREIGN KEY (thematic_unit_id) REFERENCES Thematic_Unit (thematic_unit_id) ON DELETE RESTRICT ON UPDATE CASCADE
);
CREATE TABLE Cook_National_Cuisine(
	cook_id INT UNSIGNED,
	national_cuisine_id INT UNSIGNED,
    PRIMARY KEY(cook_id,national_cuisine_id),
    CONSTRAINT fk_cook_national_cuisine_cook FOREIGN KEY (cook_id) REFERENCES Cook (cook_id) ON DELETE RESTRICT ON UPDATE CASCADE,
	CONSTRAINT fk_cook_national_cuisine_national_cuisine FOREIGN KEY (national_cuisine_id) REFERENCES National_Cuisine (national_cuisine_id) ON DELETE RESTRICT ON UPDATE CASCADE
);
